...
| `DATABASE_CA_CERT` | Optional. Supabase CA certificate (PEM). When set, the DB connection verifies the server certificate (`rejectUnauthorized: true`); when unset, TLS is unverified. |

...
// Use CommonJS require instead of ES import with the actual path
const database = require('../../lib/database');
const { query, transaction, checkDatabaseConnection } = database;

// Import mocked items
const mockLib = jest.requireMock('mysql2/promise');
const mockCalls = mockLib.mockCalls;
const mockConnection = mockLib.mockConnection;
const __resetMockCalls = mockLib.__resetMockCalls;
